...
public class ProdTest {
	...
	public void Gmail() throws InterruptedException {
		...
		//Enter Gmail Account
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("hbsqatester@gmail.com");
		
		//Click Next
		WebElement Next = driver.findElement(By.xpath("//span[text()='Next']"));
  		JavascriptExecutor next = (JavascriptExecutor)driver;
  		next.executeScript("arguments[0].click();", Next);
  		
  		
  		Thread.sleep(1000);
  		
  		//Enter Gmail Account
  		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Halo1234");
		...
		WebElement NextPw = driver.findElement(By.xpath("//span[text()='Next']"));
  		JavascriptExecutor nextpw = (JavascriptExecutor)driver;
  		nextpw.executeScript("arguments[0].click();", NextPw);
  		...
  		//Enter Gmail Search
  		driver.findElement(By.xpath("//input[@aria-label='Search mail']")).sendKeys("19092600003");
  		
  		//Click Next
		WebElement Search = driver.findElement(By.xpath("//button[@aria-label='Search Mail']"));
  		JavascriptExecutor search = (JavascriptExecutor)driver;
  		search.executeScript("arguments[0].click();", Search);
